<template>
  <div class="eyfel-index">
    ...
    <div class="eyfel-index__sliders">
      ...
      <StyledSlider v-if="womanItems.length" image-before :items="womanItems"  image-before-src="/assets/main/forWomen.png" title="Для нее" link-name="весь каталог" to="/catalog" :slide-per-view="2" />
      <StyledSlider v-if="manItems.length" image-after :items="manItems" image-after-src="/assets/main/forMan.png" title="Для него" link-name="весь каталог" to="/catalog" :slide-per-view="2" />
      <StyledSlider v-if="homeItems.length" title="Ароматы для дома" :items="homeItems"  link-name="весь каталог" to="/catalog" :slide-per-view="3" />
    </div>
    <div class="order">
      <Order />
